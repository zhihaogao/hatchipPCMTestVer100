...
namespace Arcone.Component.Tester.Function.Hatchip
{
    ...
    public partial class TESTDISP
    {
        ...
        [CharacteristicParameter(Code = "X1", Name = "X1(HZ)", Desc = "start value", DefaultValue = "20",
            ControlType = ParameterLayoutControlType.TextBox, DataType = ParameterLayoutDataType.Double)]
        [CharacteristicParameter(Code = "X2", Name = "X2", Desc = "stop value", DefaultValue = "1E6",
            ControlType = ParameterLayoutControlType.TextBox, DataType = ParameterLayoutDataType.Double)]
        [CharacteristicParameter(Code = "XStep", Name = "XStep", Desc = "step", DefaultValue = "0.4",
            ControlType = ParameterLayoutControlType.TextBox, DataType = ParameterLayoutDataType.Double)]
        [CharacteristicParameter(Code = "DotNum", Name = "DotNum", Desc = "dot number", DefaultValue = "1000",
            ControlType = ParameterLayoutControlType.TextBox, DataType = ParameterLayoutDataType.Int)]
        ...
        [CharacteristicParameter(Code = "Para2", Name = "OSCLev(V)", Desc = "VOLT LEV", DefaultValue = "0.1",
            ControlType = ParameterLayoutControlType.TextBox, DataType = ParameterLayoutDataType.Double)]
        [CharacteristicParameter(Code = "Para3", Name = "BIAS(V)", Desc = "DC BIAS", DefaultValue = "0",
            ControlType = ParameterLayoutControlType.TextBox, DataType = ParameterLayoutDataType.Double)]
        [CharacteristicParameter(Code = "Para4", Name = "AtFreqCap", Desc = "at Freq CAP", DefaultValue = "100E3",
            ControlType = ParameterLayoutControlType.TextBox, DataType = ParameterLayoutDataType.Double)]
        ...
        public void characteristics103(bool IsTestingMode)
        {
            //step1.设置图表样式
            ...
            if (IsTestingMode)
            {
                ...
                double BIAS = StaticParameter.Para3;
                ...
                var result = new List<GraphPointViewModel>();
                {
                    ...
                    for (int i = 0; i < No_step; i++)
                    {
                        ...
                        result.Add(new GraphPointViewModel() { X = Freq, Y = dataA });
                    }
